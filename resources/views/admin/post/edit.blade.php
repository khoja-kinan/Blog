          ...
          <form action="{{ route('post.update',$post->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <select class="select2" multiple="multiple" data-placeholder="Select a Categories" style="width: 100%;" name="categories[]">
                    @foreach ($categories as $category)
                      <option value="{{ $category->id }}"
                        @foreach ($post->catigories as $postCategory)
                ...
                <div class="form-check">
                  <input type="checkbox" class="form-check-input" id="publish" value="1" name="status"  @if ($post->status==1)
                      checked
                  @endif>
